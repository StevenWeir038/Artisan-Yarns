"""
Django settings for artisan_yarns project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'artisan-yarns.herokuapp.com']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'newsletter.contexts.subscription_form_contents',
            ],
            'builtins': [
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'artisan-yarns'
