# **Deployment**
Deployment was quite involved and is best broken down to the folowing sections.

It is probable these steps will remain similar for future deployments though the interfaces may change.
...
* Enter key-value pairs that match those in your project files for the keys below:
  ...
  | --------------------- | ----------------------- |
    ...
    USE_AWS               | YOUR_USE_AWS_
    EMAIL_HOST_PASS       | YOUR_EMAIL_HOST_PASS
    EMAIL_HOST_USER       | YOUR_EMAIL_HOST_USER
    DISABLE_COLLECTSTATIC | 1 (Add this variable until successful aws setup)
...
* Load data from db.json file into postgres:
  ...
  * In artisan_yarns > settings.py, add `import dj_database_url` at top of the page
...
* Load your data from the db.json file into postgres: in the terminal type the following command:
  ...
  * Alternatively create your own data directly from the Django admin
...
* A security issue exists when automatically pushing to heroku when pushing changes in Gitpod.
  * workaround is to push directly to heroku via the heroku cli in Gitpod.
  * `heroku login -i` and enter Heroku email and password
  * `heroku git:remote -a artisan-yarns` were the last name is the same as the heroku app
...
2. On GitHub, go to [StevenWeir038/Artisan-Yarns](https://github.com/StevenWeir038/Artisan-Yarns).
3. In the top right, click "Fork".

### Cloning the repository

1. Log in to [GitHub](https://www.github.com) and locate the [Repository](https://github.com/StevenWeir038/Artisan-Yarns) for this site.
...
7. Type `git clone`, and then paste the URL that was copied in Step 4.
    *`git clone https://github.com/StevenWeir038/Artisan-Yarns.git`*
8. Press Enter, and your local clone will be created.

Alternatively, if using Gitpod, you can click below to create your own workspace using this repository.

[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://github.com/StevenWeir038/Artisan-Yarns)
